...
export async function GET(request) {
  ...
  const title = searchParams.get("title") || "The Definitive Guide to Pro Esports Headphones";
  const subtitle = searchParams.get("subtitle") || "2100+ Pro Players · 150+ Headphones · 14 Games";
  const accent = searchParams.get("accent") || "#c9a227";
  ...
  return new ImageResponse(
    (
      <div style={{ background: "#f5f2e6", width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "system-ui, sans-serif", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "24px", display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ color: "#c9a227" }}>ESPORTS</span>
          <span style={{ color: "#1a1614" }}>HEADPHONES</span>
          <span style={{ color: "#9e9578", fontSize: 16 }}>.com</span>
        </div>
        {badge ? (
        ...
        {subtitle ? (
          <div style={{ fontSize: 20, color: "#7d6e1e", marginTop: "20px", letterSpacing: "0.08em", textAlign: "center", maxWidth: "900px", padding: "0 40px", display: "flex" }}>{subtitle}</div>
        ) : null}
        {(stat1 || stat2 || stat3) ? (
          <div style={{ display: "flex", gap: "40px", marginTop: "36px" }}>
            {stat1 ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "12px 24px", borderRadius: "12px", background: accent + "10", border: "1px solid " + accent + "25" }}>
                ...
                <div style={{ fontSize: 13, color: "#8a8460", textTransform: "uppercase", letterSpacing: "0.1em", marginTop: "4px", display: "flex" }}>{s1Label}</div>
              </div>
            ) : null}
            {stat2 ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "12px 24px", borderRadius: "12px", background: accent + "10", border: "1px solid " + accent + "25" }}>
                <div style={{ fontSize: 32, fontWeight: 900, color: accent, display: "flex" }}>{stat2}</div>
                <div style={{ fontSize: 13, color: "#8a8460", textTransform: "uppercase", letterSpacing: "0.1em", marginTop: "4px", display: "flex" }}>{s2Label}</div>
              </div>
            ) : null}
            {stat3 ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "12px 24px", borderRadius: "12px", background: accent + "10", border: "1px solid " + accent + "25" }}>
                <div style={{ fontSize: 32, fontWeight: 900, color: accent, display: "flex" }}>{stat3}</div>
                <div style={{ fontSize: 13, color: "#8a8460", textTransform: "uppercase", letterSpacing: "0.1em", marginTop: "4px", display: "flex" }}>{s3Label}</div>
              </div>
            ) : null}
          </div>
        ) : null}
        ...
        <div style={{ position: "absolute", bottom: "24px", fontSize: 16, color: accent + "60", letterSpacing: "0.15em", display: "flex" }}>esportsheadphones.com</div>
      </div>
    ),
