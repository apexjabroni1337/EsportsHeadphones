...
const ARTICLES = {
  ...
  "hall-effect-vs-mechanical-switches": {
    ...
    color: "#6b8cad",
    content: () => [
      { type: "p", text: "Every FPS player has different priorities, but your choice of driver type and layout has a massive impact on which headphone will feel best in your hand. Understanding your grip is the first step to finding the right headphone." },
      ...
      { type: "cta", text: "Find headphones by shape →", href: "/best" },
    ],
  },
  "headphone-weight-trend-2024-2026": {
    ...
    color: "#b8956a",
    content: () => [
      { type: "p", text: "In 2018, rapid trigger headphones didn't exist. By 2026, every major manufacturer offers some version of instant actuation. This is the story of how a single innovation changed the entire competitive landscape." },
      { type: "h2", text: "The Wooting Effect" },
      { type: "p", text: "It started with Wooting. The 60HE in 2021 introduced rapid trigger to mainstream competitive gaming — a concept that let players actuate keys faster than any traditional mechanical driver could manage. By 2023, every major manufacturer was developing hall effect or rapid trigger headphones." },
      ...
      { type: "p", text: "The average headphone used by a professional player in February 2026 has some form of adjustable actuation or rapid trigger technology. The race has shifted from 'do you have it' to 'how many activation points can it support.' The current standard is 1.0-1.5mm adjustable actuation for competitive headphones." },
      ...
      { type: "cta", text: "View driver technology trends →", href: "/trends" },
    ],
  },
  ...
  "rapid-trigger-actuation-explained": {
    ...
    color: "#c4444f",
    content: () => [
      { type: "p", text: "Rapid trigger and adjustable actuation are revolutionary headphone technologies that have changed competitive gaming. Learn how they work and why pros prefer them." },
      ...
      { type: "p", text: "Yes. Over 80% of professional esports players now use headphones with rapid trigger or Hall Effect switches. The technology has become the standard for competitive gaming." },
      { type: "cta", text: "Browse rapid trigger headphones →", href: "/headphones" },
    ],
  },
};
