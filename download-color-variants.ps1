...
# Color variant and special edition headphones that need their own images
$headphones = @(
    @{ Name = "Logitech-G733-Lilac";                                ASIN = "B08141HYHG" },
    @{ Name = "Logitech-G733-Black";                                ASIN = "B081415GCS" },
    @{ Name = "Logitech-G-PRO-X-2-Magenta";                        ASIN = "B0B3F784ZG" },
    @{ Name = "Razer-BlackShark-V3-Pro-Dragon-Lore";                ASIN = "B0FSGK5BJJ" },
    @{ Name = "Razer-BlackShark-V3-Pro-Green";                      ASIN = "B0F3QDLZKG" },
    @{ Name = "Corsair-HS80-RGB-USB";                               ASIN = "B0BQBW1W1D" },
    @{ Name = "Logitech-G-Pro-X-Headset-League-of-Legends-Edition"; ASIN = "B0943KKQJX" }
)
...
Write-Host "=== Downloading 7 Color Variant / Special Edition Images ===" -ForegroundColor Cyan
