...
export const metadata = {
  title: "Pro Esports Teams — Headphone & Gear Choices by Organization",
  description: "Explore headphone and gear choices across 350+ professional esports teams. See what headphones Team Liquid, FaZe Clan, Fnatic, Natus Vincere, G2, and every other pro org use across CS2, Valorant, LoL, Dota 2, and more.",
  alternates: { canonical: "https://esportsheadphones.com/teams" },
  openGraph: {
    title: "Pro Esports Teams — Headphone & Gear Choices by Organization",
    description: "Explore headphone and gear choices across 350+ professional esports teams.",
    url: "https://esportsheadphones.com/teams",
    images: [{ url: "https://esportsheadphones.com/og?title=Teams&subtitle=Headphone+choices+across+350%2B+pro+esports+organizations", width: 1200, height: 630 }],
  },
  twitter: {
    ...
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: topTeams.slice(0, 20).map(([team, data], i) => ({
          ...
          url: `https://esportsheadphones.com/teams/${slug(team)}`,
          name: team,
      ...
      >
        <h1>Professional Esports Teams — Headphone & Gear Data</h1>
        <p>
          Comprehensive headphone and peripheral data for {teamCount} professional esports organizations
