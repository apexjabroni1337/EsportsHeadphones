...
export const metadata = {
  ...
  description: "Track the evolution of pro esports headphones from 2019-2025. Weight trends, frequency response adoption, wireless growth, price changes, brand dominance shifts, and technology adoption data.",
...
export default function TrendsPage() {
  ...
  const over4k = headphones.filter((m) => m.frequencyResponse >= 4000);
  const over8k = headphones.filter((m) => m.frequencyResponse >= 8000);
    ...
    <>
      ...
      >
        ...
        <p>
          ...
          to 8KHz frequency responses and near-universal wireless adoption, competitive peripherals have evolved
        ...
        <ul>
          ...
          <li>4KHz+ frequency response: {over4k.length} headphones ({Math.round(over4k.length/headphones.length*100)}% of database)</li>
          <li>8KHz frequency response: {over8k.length} headphones</li>
        ...
        <h2>Maximum Freq. Response Trend</h2>
        ...
        <ul>
          ...
          <li>2021 — Wooting 60HE introduces active noise cancellation to mainstream competitive gaming</li>
          ...
          <li>2025 — HITS (magnetic induction) drivers debut in Logitech Superstrike; PAW3950 switch launches</li>
        </ul>
