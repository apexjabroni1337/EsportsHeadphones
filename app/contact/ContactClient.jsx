...
const I = {
  headphone: (s = 20) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="6" width="20" height="12" rx="2"/><line x1="6" y1="10" x2="6" y2="10"/><line x1="10" y1="10" x2="10" y2="10"/><line x1="14" y1="10" x2="14" y2="10"/><line x1="18" y1="10" x2="18" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/></svg>,
...
export default function ContactClient() {
    ...
    try {
      const res = await fetch(`https://formspree.io/f/${FORMSPREE_ID}`, {
        ...
        body: JSON.stringify({
          ...
          _subject: `[EsportsHeadphones] ${form.subject === "correction" ? "Data Correction" : form.subject === "feature" ? "Feature Request" : form.subject === "partnership" ? "Partnership Inquiry" : "General"}: from ${form.name}`,
        }),
      });
  ...
  const subjects = [
    ...
    { value: "correction", label: "Data Correction", icon: I.bug, desc: "Wrong headphone, player info, or stats" },
