...
export const metadata = {
  title: "Blog — EsportsHeadphones",
  description: "Esports headphone guides, pro gear analysis, and data-driven insights. Learn what the pros use and why.",
  alternates: { canonical: "https://esportsheadphones.com/blog" },
  openGraph: {
    title: "Blog — EsportsHeadphones",
    description: "Esports headphone guides, pro gear analysis, and data-driven insights.",
...
const ARTICLES = [
  {
    ...
    excerpt: "Shape, weight, driver, wireless vs wired — the complete guide to finding your perfect headphone based on what the pros actually use.",
    date: "2026-02-23",
    tag: "Guide",
    color: "#b8956a",
  },
  {
    ...
    title: "Hall Effect vs Mechanical Driveres: Which Is Best for Competitive Gaming?",
    excerpt: "We analyzed grip styles across 2,000+ pro players to find which grip dominates each game — and which headphones match each style.",
    date: "2026-02-23",
    tag: "Analysis",
    color: "#6b8cad",
  },
