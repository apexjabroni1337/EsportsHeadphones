...
const BEST_PAGES = {
  ...
  "apex": { game: "Apex", full: "Apex Legends", tab: "apex", intro: "Apex Legends' fast-paced movement system, including sliding, climbing, and character abilities, demands a headphone that can track fast-moving targets while maintaining accuracy during chaotic gunfights. Pros need excellent tracking aim for weapons like the R-301 and R-99.", tips: "Apex pros use moderate sensitivity — higher than CS2 but lower than Fortnite. Tracking aim is more important than flick aim, so consistent driver performance matters. Many top players prefer ergonomic layouts for comfort during long play sessions." },
  ...
  "wireless": { game: null, full: "Wireless Gaming", tab: null, intro: "Wireless gaming headphones have completely taken over the esports scene. In 2025, the vast majority of professional players across all games use wireless headphones. Modern wireless technology has eliminated any latency disadvantage, while the freedom of no cable drag has made wireless the clear choice for competitive play.", tips: "All top wireless headphones now feature sub-1ms latency. The key differentiators are weight, battery life, and shape. Look for headphones with 4000Hz polling rate support for the absolute lowest latency." },
  ...
  "budget": { game: null, full: "Budget Esports", tab: null, intro: "You don't need to spend $150+ to get a tournament-capable gaming headphone. Several excellent esports headphones are available under $60, offering the same sensors and similar shapes to their premium counterparts. Budget headphones in 2025 offer incredible value for competitive gamers.", tips: "Look for headphones with PAW3395 or equivalent sensors — even budget headphones now include top-tier switches. The main tradeoffs at lower prices are typically in build quality, weight, and battery life rather than performance." },
};
